...
//  FUNCTION TO CONVERT HTML TO IMAGE 
  ...
  return (
   <>
   <div className="flex flex-col bg-white max-w-[520px] p-1 sm:p-5 rounded-md shadow-md border bg-card text-black"  ref={elementRef} >
    {/* HEAD  */}
            <div className="flex flex-row justify-between w-full p-2 sm:p-5 text-black">
              ...
              <div className="flex flex-col items-center justify-center gap-2">
                <span className="text-3xl font-bold text-center text-black "> {estimated} $</span>
                <span className="text-xl font-normal text-center text-black"> Estimated Worth</span>
              </div>
            </div>
            {/* BODY  */}
